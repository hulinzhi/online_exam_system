...
import com.dimple.dao.*;
import com.dimple.entity.*;
...
public class ExamServiceImpl implements ExamService {
    ...
    public int insert(Exam exam) {
        ...
        Integer[] classIds = exam.getClassIds();
...
//        }
    ...
    public int deleteByIds(String ids) {
        ...
        for (Integer integer : examIds){
            examStudentDao.deleteByExamId(integer);
        }
